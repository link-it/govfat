	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , ResultSet rs) throws ServiceException {
		...
		try{
			...
			if(model.equals(Ente.model())){
				...
				setParameter(object, "setEndpoint", Ente.model().ENDPOINT.getFieldType(),
						jdbcParameterUtilities.readParameter(rs, "endpoint", Ente.model().ENDPOINT.getFieldType()));
				setParameter(object, "setEndpointConsegnaLotto", Ente.model().ENDPOINT_CONSEGNA_LOTTO.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "endpoint_consegna_lotto", Ente.model().ENDPOINT_CONSEGNA_LOTTO.getFieldType()));
				setParameter(object, "setEndpointRichiediProtocollo", Ente.model().ENDPOINT_RICHIEDI_PROTOCOLLO.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "endpoint_richiedi_protocollo", Ente.model().ENDPOINT_RICHIEDI_PROTOCOLLO.getFieldType()));
				return object;
			}
