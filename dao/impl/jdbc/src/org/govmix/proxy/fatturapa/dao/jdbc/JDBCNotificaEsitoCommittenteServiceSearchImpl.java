...
import org.govmix.proxy.fatturapa.dao.jdbc.fetch.NotificaEsitoCommittenteFetch;
...
public class JDBCNotificaEsitoCommittenteServiceSearchImpl implements IJDBCServiceSearchWithoutId<NotificaEsitoCommittente, JDBCServiceManager> {
	...
	@Override
	public List<NotificaEsitoCommittente> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression) throws NotImplementedException, ServiceException,Exception {
	...
	@Override
	public NotificaEsitoCommittente find(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression) 
	...
	@Override
	public NotificaEsitoCommittente get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		return this._get(jdbcProperties, log, connection, sqlQueryObject, Long.valueOf(tableId));
	}
	
	private NotificaEsitoCommittente _get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		...
		sqlQueryObjectGet_notificaEsitoCommittente_fatturaElettronica_readFkId.addFromTable("esito_committente");
		...
		notificaEsitoCommittente.setIdFattura(JDBCFatturaElettronicaUtils.toFatturaId(jdbcProperties, log, connection, sqlQueryObject, idFK_notificaEsitoCommittente_fatturaElettronica));

		
		// Object _notificaEsitoCommittente_fatturaElettronica (recupero id)
		ISQLQueryObject sqlQueryObjectGet_notificaEsitoCommittente_utente_readFkId = sqlQueryObjectGet.newSQLQueryObject();
		sqlQueryObjectGet_notificaEsitoCommittente_utente_readFkId.addFromTable("esito_committente");
		...
		notificaEsitoCommittente.setUtente(JDBCUtenteUtils.toLogicId(jdbcProperties, log, connection, sqlQueryObject, idFK_notificaEsitoCommittente_utente));		
