...
public class JDBCAllegatoFatturaServiceImpl extends JDBCAllegatoFatturaServiceSearchImpl
	...
	@Override
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, AllegatoFattura allegatoFattura) throws NotImplementedException,ServiceException,Exception {
		...
		Long id_fatturaElettronica = JDBCFatturaElettronicaUtils.toLongId(jdbcProperties, log, connection, sqlQueryObject, allegatoFattura.getIdFattura());
	...
	@Override
	public void update(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, AllegatoFattura allegatoFattura) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		Long longId = allegatoFattura.getId();
		...
		lstObjects_allegatoFattura.add(new JDBCObject(longId, Long.class));
	...
	@Override
	public void updateOrCreate(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, AllegatoFattura allegatoFattura) throws NotImplementedException,ServiceException,Exception {
	
		Long id = allegatoFattura.getId();
		if(id != null && this.exists(jdbcProperties, log, connection, sqlQueryObject, id)) {
			this.update(jdbcProperties, log, connection, sqlQueryObject, allegatoFattura);		
		} else {
			this.create(jdbcProperties, log, connection, sqlQueryObject, allegatoFattura);
		}
