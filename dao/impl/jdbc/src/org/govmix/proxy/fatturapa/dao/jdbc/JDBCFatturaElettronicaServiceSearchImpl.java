...
import org.govmix.proxy.fatturapa.dao.jdbc.fetch.FatturaElettronicaFetch;
...
public class JDBCFatturaElettronicaServiceSearchImpl implements IJDBCServiceSearchWithId<FatturaElettronica, IdFattura, JDBCServiceManager> {
	...
	@Override
	public FatturaElettronica get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdFattura id) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException,Exception {
		Long id_fatturaElettronica = this.findIdFatturaElettronica(jdbcProperties, log, connection, sqlQueryObject, id, true);
		return this._get(jdbcProperties, log, connection, sqlQueryObject, id_fatturaElettronica);
	...
	@Override
	public List<IdFattura> findAllIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression) throws NotImplementedException, ServiceException,Exception {
	...
	@Override
	public List<FatturaElettronica> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression) throws NotImplementedException, ServiceException,Exception {
        ...
        try {
			...
			for(Map<String, Object> map: returnMap) {
				Object decTermObj = map.remove(idDecorrenzaTerminiField);
				...
				if(decTermObj != null && decTermObj instanceof Long) {
					Long idDecorrenzaTermini = (Long) decTermObj;
					fatturaElettronica.setIdDecorrenzaTermini(JDBCNotificaDecorrenzaTerminiUtils.toLogicId(jdbcProperties, log, connection, sqlQueryObject, idDecorrenzaTermini));
				}
	...
	@Override
	public FatturaElettronica find(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression) 
	...
	@Override
	public FatturaElettronica get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		return this._get(jdbcProperties, log, connection, sqlQueryObject, Long.valueOf(tableId));
	}
	
	private FatturaElettronica _get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		...
		try {
			...
			sqlQueryObjectGet_fatturaElettronica_notificaDecorrenzaTermini_readFkId.addFromTable("fatture");
			...
			if(idFK_fatturaElettronica_notificaDecorrenzaTermini != null && idFK_fatturaElettronica_notificaDecorrenzaTermini.longValue() > 0) {
				fatturaElettronica.setIdDecorrenzaTermini(JDBCNotificaDecorrenzaTerminiUtils.toLogicId(jdbcProperties, log, connection, sqlQueryObject, idFK_fatturaElettronica_notificaDecorrenzaTermini));
			}
	...
	private boolean _exists(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId) throws MultipleResultException, NotImplementedException, ServiceException, Exception {
		...
		sqlQueryObject.addSelectField(this.getFatturaElettronicaFieldConverter().toColumn(FatturaElettronica.model().IDENTIFICATIVO_SDI,true));
	...
	protected Long findIdFatturaElettronica(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdFattura id, boolean throwNotFound) throws NotFoundException, ServiceException, NotImplementedException, Exception {
		...
		return JDBCFatturaElettronicaUtils.toLongId(jdbcProperties, log, connection, sqlQueryObject, id, throwNotFound);
	}
}
