...
import org.govmix.proxy.fatturapa.dao.jdbc.fetch.NotificaDecorrenzaTerminiFetch;
...
public class JDBCNotificaDecorrenzaTerminiServiceSearchImpl implements IJDBCServiceSearchWithId<NotificaDecorrenzaTermini, IdNotificaDecorrenzaTermini, JDBCServiceManager> {
	...
	@Override
	public NotificaDecorrenzaTermini get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, IdNotificaDecorrenzaTermini id) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException,Exception {
		...
		return this._get(jdbcProperties, log, connection, sqlQueryObject, id_notificaDecorrenzaTermini);
	...
	@Override
	public List<IdNotificaDecorrenzaTermini> findAllIds(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression) throws NotImplementedException, ServiceException,Exception {
        ...
        for(Long id: ids) {
        	NotificaDecorrenzaTermini notificaDecorrenzaTermini = this.get(jdbcProperties, log, connection, sqlQueryObject, id);
	...
	@Override
	public List<NotificaDecorrenzaTermini> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression) throws NotImplementedException, ServiceException,Exception {
	...
	@Override
	public NotificaDecorrenzaTermini find(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression) 
	...
	@Override
	public NotificaDecorrenzaTermini get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		return this._get(jdbcProperties, log, connection, sqlQueryObject, Long.valueOf(tableId));
	}
	
	private NotificaDecorrenzaTermini _get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
