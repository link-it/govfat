...
public class JDBCNotificaEsitoCommittenteServiceImpl extends JDBCNotificaEsitoCommittenteServiceSearchImpl
	...
	@Override
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, NotificaEsitoCommittente notificaEsitoCommittente) throws NotImplementedException,ServiceException,Exception {
		...
		Long id_utente = JDBCUtenteUtils.toLongId(jdbcProperties, log, connection, sqlQueryObject, notificaEsitoCommittente.getUtente());

		Long id_fatturaElettronica = JDBCFatturaElettronicaUtils.toLongId(jdbcProperties, log, connection, sqlQueryObject, notificaEsitoCommittente.getIdFattura());
	...
	@Override
	public void update(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, NotificaEsitoCommittente notificaEsitoCommittente) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		Long longId = notificaEsitoCommittente.getId();
		...
		lstObjects_notificaEsitoCommittente.add(new JDBCObject(longId, Long.class));
	...
	@Override
	public void updateOrCreate(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, NotificaEsitoCommittente notificaEsitoCommittente) throws NotImplementedException,ServiceException,Exception {
	
		Long id = notificaEsitoCommittente.getId();
		if(id != null && this.exists(jdbcProperties, log, connection, sqlQueryObject, id)) {
			this.update(jdbcProperties, log, connection, sqlQueryObject, notificaEsitoCommittente);		
		} else {
			this.create(jdbcProperties, log, connection, sqlQueryObject, notificaEsitoCommittente);
		}
