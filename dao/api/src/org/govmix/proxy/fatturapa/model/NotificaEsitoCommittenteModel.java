...
public class NotificaEsitoCommittenteModel extends AbstractModel<NotificaEsitoCommittente> {
	...
	public NotificaEsitoCommittenteModel(){
		...
		this.ID_FATTURA = new org.govmix.proxy.fatturapa.model.IdFatturaModel(new Field("idFattura",org.govmix.proxy.fatturapa.IdFattura.class,"NotificaEsitoCommittente",NotificaEsitoCommittente.class));
		...
		this.UTENTE = new org.govmix.proxy.fatturapa.model.IdUtenteModel(new Field("utente",org.govmix.proxy.fatturapa.IdUtente.class,"NotificaEsitoCommittente",NotificaEsitoCommittente.class));
	...
	public NotificaEsitoCommittenteModel(IField father){
		...
		this.ID_FATTURA = new org.govmix.proxy.fatturapa.model.IdFatturaModel(new ComplexField(father,"idFattura",org.govmix.proxy.fatturapa.IdFattura.class,"NotificaEsitoCommittente",NotificaEsitoCommittente.class));
		...
		this.UTENTE = new org.govmix.proxy.fatturapa.model.IdUtenteModel(new ComplexField(father,"utente",org.govmix.proxy.fatturapa.IdUtente.class,"NotificaEsitoCommittente",NotificaEsitoCommittente.class));
	...
	public org.govmix.proxy.fatturapa.model.IdUtenteModel UTENTE = null;
