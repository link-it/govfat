...
public class RegistroPropertyValueModel extends AbstractModel<RegistroPropertyValue> {
	...
	public RegistroPropertyValueModel(){
		...
		this.ID_PROPERTY = new org.govmix.proxy.fatturapa.model.IdPropertyModel(new Field("id-property",org.govmix.proxy.fatturapa.IdProperty.class,"RegistroPropertyValue",RegistroPropertyValue.class));
	...
	public RegistroPropertyValueModel(IField father){
		...
		this.ID_PROPERTY = new org.govmix.proxy.fatturapa.model.IdPropertyModel(new ComplexField(father,"id-property",org.govmix.proxy.fatturapa.IdProperty.class,"RegistroPropertyValue",RegistroPropertyValue.class));
