...
import org.govmix.proxy.fatturapa.dao.IDBDipartimentoPropertyServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.DipartimentoProperty} 
 *
...
public class JDBCDipartimentoPropertyServiceSearch implements IDBDipartimentoPropertyServiceSearch, IDBServiceUtilities<DipartimentoProperty> {
	...
	protected IJDBCServiceSearchWithId<DipartimentoProperty, IdProperty, JDBCServiceManager> serviceSearch = null;
	...
	@Override
	public IdProperty convertToId(DipartimentoProperty obj)
	...
	@Override
	public DipartimentoProperty get(IdProperty id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdProperty.class.getName()+") 'id' is null");
			}
	...
	@Override
	public boolean exists(IdProperty id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdProperty> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdProperty id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdProperty id, DipartimentoProperty obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	public void mappingTableIds(long tableId, DipartimentoProperty obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdProperty.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+DipartimentoProperty.class.getName()+") 'obj' is null");
			}
