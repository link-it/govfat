...
import org.govmix.proxy.fatturapa.dao.IDBDipartimentoServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.Dipartimento} 
 *
...
public class JDBCDipartimentoServiceSearch implements IDBDipartimentoServiceSearch, IDBServiceUtilities<Dipartimento> {
	...
	public List<Dipartimento> findAll(IPaginatedExpression expression, boolean fetchChildren) throws ServiceException, NotImplementedException {
		...
		try{
			...
			return this.serviceSearch.findAll(this.jdbcProperties,this.log,connection,sqlQueryObject,jdbcPaginatedExpression, fetchChildren);			
