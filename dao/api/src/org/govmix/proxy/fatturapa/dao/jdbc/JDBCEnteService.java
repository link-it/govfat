...
import org.govmix.proxy.fatturapa.dao.IDBEnteService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.Ente} 
 *
...
public class JDBCEnteService extends JDBCEnteServiceSearch  implements IDBEnteService {
	...
	public void create(Ente ente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,ente);			
	...
	public void update(IdEnte oldId, Ente ente, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,ente);
	...
	public void updateOrCreate(IdEnte oldId, Ente ente) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, ente, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void updateOrCreate(IdEnte oldId, Ente ente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,ente);
