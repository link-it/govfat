...
import org.govmix.proxy.fatturapa.dao.IDBDipartimentoPropertyService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.DipartimentoProperty} 
 *
...
public class JDBCDipartimentoPropertyService extends JDBCDipartimentoPropertyServiceSearch  implements IDBDipartimentoPropertyService {
	...
	private IJDBCServiceCRUDWithId<DipartimentoProperty, IdProperty, JDBCServiceManager> serviceCRUD = null;
	...
	public void create(DipartimentoProperty dipartimentoProperty) throws ServiceException, NotImplementedException {
		try{
			this.create(dipartimentoProperty, false);
	...
	public void create(DipartimentoProperty dipartimentoProperty, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,dipartimentoProperty);			
	...
	@Override
	public void update(IdProperty oldId, DipartimentoProperty dipartimentoProperty) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, dipartimentoProperty, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdProperty oldId, DipartimentoProperty dipartimentoProperty, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			if(oldId==null){
				throw new Exception("Parameter (type:"+IdProperty.class.getName()+") 'oldId' is null");
			}
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,dipartimentoProperty);
	...
	@Override
	public void updateFields(IdProperty id, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(IdProperty id, IExpression condition, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(IdProperty id, UpdateModel ... updateModels) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateOrCreate(IdProperty oldId, DipartimentoProperty dipartimentoProperty) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, dipartimentoProperty, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdProperty oldId, DipartimentoProperty dipartimentoProperty, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,dipartimentoProperty);
	...
	@Override
	public void deleteById(IdProperty id) throws ServiceException, NotImplementedException {
