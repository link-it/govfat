...
import org.govmix.proxy.fatturapa.dao.IDBFatturaElettronicaService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.FatturaElettronica} 
 *
...
public class JDBCFatturaElettronicaService extends JDBCFatturaElettronicaServiceSearch  implements IDBFatturaElettronicaService {
	...
	public void create(FatturaElettronica fatturaElettronica) throws ServiceException, NotImplementedException {
		try{
			this.create(fatturaElettronica, false);
	...
	public void create(FatturaElettronica fatturaElettronica, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,fatturaElettronica);			
	...
	public void update(IdFattura oldId, FatturaElettronica fatturaElettronica) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, fatturaElettronica, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void update(IdFattura oldId, FatturaElettronica fatturaElettronica, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,fatturaElettronica);
	...
	public void updateOrCreate(IdFattura oldId, FatturaElettronica fatturaElettronica) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, fatturaElettronica, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void updateOrCreate(IdFattura oldId, FatturaElettronica fatturaElettronica, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,fatturaElettronica);
