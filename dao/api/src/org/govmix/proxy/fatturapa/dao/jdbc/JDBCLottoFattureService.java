...
import org.govmix.proxy.fatturapa.dao.IDBLottoFattureService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.LottoFatture} 
 *
...
public class JDBCLottoFattureService extends JDBCLottoFattureServiceSearch  implements IDBLottoFattureService {
	...
	public void create(LottoFatture lottoFatture) throws ServiceException, NotImplementedException {
		try{
			this.create(lottoFatture, false);
	...
	public void create(LottoFatture lottoFatture, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,lottoFatture);			
	...
	public void update(IdLotto oldId, LottoFatture lottoFatture) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, lottoFatture, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void update(IdLotto oldId, LottoFatture lottoFatture, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,lottoFatture);
	...
	public void updateOrCreate(IdLotto oldId, LottoFatture lottoFatture) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, lottoFatture, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void updateOrCreate(IdLotto oldId, LottoFatture lottoFatture, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,lottoFatture);
