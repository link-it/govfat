...
import org.govmix.proxy.fatturapa.dao.IDBRegistroPropertyService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.RegistroProperty} 
 *
...
public class JDBCRegistroPropertyService extends JDBCRegistroPropertyServiceSearch  implements IDBRegistroPropertyService {
	...
	private IJDBCServiceCRUDWithId<RegistroProperty, IdProperty, JDBCServiceManager> serviceCRUD = null;
	...
	public void create(RegistroProperty registroProperty) throws ServiceException, NotImplementedException {
		try{
			this.create(registroProperty, false);
	...
	public void create(RegistroProperty registroProperty, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,registroProperty);			
	...
	@Override
	public void update(IdProperty oldId, RegistroProperty registroProperty) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, registroProperty, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdProperty oldId, RegistroProperty registroProperty, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,registroProperty);
	...
	@Override
	public void updateOrCreate(IdProperty oldId, RegistroProperty registroProperty) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, registroProperty, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdProperty oldId, RegistroProperty registroProperty, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,registroProperty);
