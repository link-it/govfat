...
import org.govmix.proxy.fatturapa.dao.IDBRegistroPropertyServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.RegistroProperty} 
 *
...
public class JDBCRegistroPropertyServiceSearch implements IDBRegistroPropertyServiceSearch, IDBServiceUtilities<RegistroProperty> {
	...
	protected IJDBCServiceSearchWithId<RegistroProperty, IdProperty, JDBCServiceManager> serviceSearch = null;
	...
	@Override
	public IdProperty convertToId(RegistroProperty obj)
	...
	@Override
	public RegistroProperty get(IdProperty id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdProperty id, RegistroProperty obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
