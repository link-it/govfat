...
public interface IJDBCDipartimentoServiceSearch extends IJDBCServiceSearchWithId<Dipartimento, IdDipartimento, JDBCServiceManager> {
	...
	public List<Dipartimento> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log,Connection connection,ISQLQueryObject sqlObject,JDBCPaginatedExpression expression, boolean fetchChildren) throws NotImplementedException,ServiceException,Exception;
