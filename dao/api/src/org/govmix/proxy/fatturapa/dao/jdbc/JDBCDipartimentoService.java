...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.Dipartimento} 
 *
...
public class JDBCDipartimentoService extends JDBCDipartimentoServiceSearch  implements IDBDipartimentoService {
	...
	public void create(Dipartimento dipartimento) throws ServiceException, NotImplementedException {
		try{
			this.create(dipartimento, false);
	...
	public void create(Dipartimento dipartimento, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,dipartimento);			
	...
	public void update(IdDipartimento oldId, Dipartimento dipartimento) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, dipartimento, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void update(IdDipartimento oldId, Dipartimento dipartimento, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,dipartimento);
	...
	public void updateOrCreate(IdDipartimento oldId, Dipartimento dipartimento) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, dipartimento, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void updateOrCreate(IdDipartimento oldId, Dipartimento dipartimento, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,dipartimento);
