...
import org.govmix.proxy.fatturapa.dao.IDBUtenteService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.Utente} 
 *
...
public class JDBCUtenteService extends JDBCUtenteServiceSearch  implements IDBUtenteService {
	...
	public void create(Utente utente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,utente);			
	...
	public void update(IdUtente oldId, Utente utente) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, utente, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void update(IdUtente oldId, Utente utente, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,utente);
	...
	public void updateOrCreate(IdUtente oldId, Utente utente) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, utente, false);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void updateOrCreate(IdUtente oldId, Utente utente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,utente);
