 ...
 * 			&lt;element name="cedentePrestatoreDenominazione" type="{http://www.govmix.org/proxy/fatturapa}normalizedString" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="cedentePrestatorePaese" type="{http://www.govmix.org/proxy/fatturapa}string" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="cedentePrestatoreCodiceFiscale" type="{http://www.govmix.org/proxy/fatturapa}string" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="cessionarioCommittenteDenominazione" type="{http://www.govmix.org/proxy/fatturapa}normalizedString" minOccurs="1" maxOccurs="1"/>
 ...
 * 			&lt;element name="tipoDocumento" type="{http://www.govmix.org/proxy/fatturapa}TipoDocumentoType" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="divisa" type="{http://www.govmix.org/proxy/fatturapa}string" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="data" type="{http://www.govmix.org/proxy/fatturapa}date" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="anno" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="numero" type="{http://www.govmix.org/proxy/fatturapa}normalizedString" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="esito" type="{http://www.govmix.org/proxy/fatturapa}EsitoType" minOccurs="0" maxOccurs="1"/>
 * 			&lt;element name="importoTotaleDocumento" type="{http://www.govmix.org/proxy/fatturapa}decimal" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="importoTotaleRiepilogo" type="{http://www.govmix.org/proxy/fatturapa}decimal" minOccurs="1" maxOccurs="1"/>
 * 			&lt;element name="causale" type="{http://www.govmix.org/proxy/fatturapa}normalizedString" minOccurs="0" maxOccurs="1"/>
 * 			&lt;element name="statoConsegna" type="{http://www.govmix.org/proxy/fatturapa}StatoConsegnaType" minOccurs="1" maxOccurs="1" default="NON_CONSEGNATA"/>
...
public class FatturaElettronica extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  public org.govmix.proxy.fatturapa.constants.TipoDocumentoType getTipoDocumento() {
    return this.tipoDocumento;
  }

  public void setTipoDocumento(org.govmix.proxy.fatturapa.constants.TipoDocumentoType tipoDocumento) {
  ...
  public org.govmix.proxy.fatturapa.constants.EsitoType getEsito() {
    return this.esito;
  }

  public void setEsito(org.govmix.proxy.fatturapa.constants.EsitoType esito) {
    this.esito = esito;
  }
  ...
  private static org.govmix.proxy.fatturapa.model.FatturaElettronicaModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(org.govmix.proxy.fatturapa.FatturaElettronica.modelStaticInstance==null){
  			org.govmix.proxy.fatturapa.FatturaElettronica.modelStaticInstance = new org.govmix.proxy.fatturapa.model.FatturaElettronicaModel();
	  }
  }
  public static org.govmix.proxy.fatturapa.model.FatturaElettronicaModel model(){
	  if(org.govmix.proxy.fatturapa.FatturaElettronica.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return org.govmix.proxy.fatturapa.FatturaElettronica.modelStaticInstance;
  }
