...
public enum FormatoTrasmissioneType implements IEnumeration , Serializable , Cloneable {
	...
	public static FormatoTrasmissioneType toEnumConstant(String value){
		...
		if(FormatoTrasmissioneType.SDI11.getValue().equals(value)){
			res = FormatoTrasmissioneType.SDI11;
		}else if(FormatoTrasmissioneType.SDI10.getValue().equals(value)){
			res = FormatoTrasmissioneType.SDI10;
		}
		return res;
	}
	...
	public static IEnumeration toEnumConstantFromString(String value){
		FormatoTrasmissioneType res = null;
		if(FormatoTrasmissioneType.SDI11.toString().equals(value)){
			res = FormatoTrasmissioneType.SDI11;
		}else if(FormatoTrasmissioneType.SDI10.toString().equals(value)){
			res = FormatoTrasmissioneType.SDI10;
		}
		return res;
	}
