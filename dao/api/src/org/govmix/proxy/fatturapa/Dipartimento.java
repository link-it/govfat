 ...
 * 		&lt;sequence>
 * 			&lt;element name="codice" type="{http://www.govmix.org/proxy/fatturapa}string" minOccurs="1" maxOccurs="1"/>
 ...
 * 			&lt;element name="registro" type="{http://www.govmix.org/proxy/fatturapa}id-registro" minOccurs="0" maxOccurs="1"/>
 * 			&lt;element name="DipartimentoPropertyValue" type="{http://www.govmix.org/proxy/fatturapa}DipartimentoPropertyValue" minOccurs="0" maxOccurs="unbounded"/>
 * 		&lt;/sequence>
 * &lt;/complexType>
 * </pre>
 * 
...
public class Dipartimento extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static org.govmix.proxy.fatturapa.model.DipartimentoModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(org.govmix.proxy.fatturapa.Dipartimento.modelStaticInstance==null){
  			org.govmix.proxy.fatturapa.Dipartimento.modelStaticInstance = new org.govmix.proxy.fatturapa.model.DipartimentoModel();
	  }
  }
  public static org.govmix.proxy.fatturapa.model.DipartimentoModel model(){
	  if(org.govmix.proxy.fatturapa.Dipartimento.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return org.govmix.proxy.fatturapa.Dipartimento.modelStaticInstance;
  }
