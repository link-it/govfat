...
public class EndpointEnteForzaInvioImpl extends EndpointEnteImpl implements EndpointEnteForzaInvio {
	...
	@Override
	public Response forzaInvioLotto(Integer idSdI, String consegnaDocumentiAccessori) {
		//forzaInvioLotto
		try {
			boolean consegna;
	...
	@Override
	public Response elencoFattureRicevute(Integer idSdI) {
		String lst;
		try {
			this.log.info("Invoke elencoFattureRicevute");
	...
	@Override
	public Response forzaInvioFattura(Integer idSdI, Integer posizione, String consegnaDocumentiAccessori) {
		//forzaInvioFattura
