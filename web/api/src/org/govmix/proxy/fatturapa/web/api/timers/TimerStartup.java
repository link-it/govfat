...
public class TimerStartup implements ServletContextListener {
	...
	class TimerStartupThread implements Runnable {
		...
		public void run() {
			...
			try {
				...
				TimerStartup.log.error("Errore durante la lettura delle WebApiProperties", e);
				return;
			}
		...
		private List<TimerObject> initTimers(WebApiProperties properties) throws Exception {
		...
		private TimerObject createEJBTimer(String timerName, WebApiProperties properties) throws Exception {
		...
		private TimerObject createThreadTimer(String timerName, WebApiProperties properties) throws Exception {
		...
		private boolean lookupTimer(String timerName, WebApiProperties properties, GestoreJNDI jndi) {
	...
	private static TimerConsegnaFattura createTimerConsegnaFattura(WebApiProperties properties) throws Exception {
	...
	private static TimerInserimentoFattura createTimerInserimentoFattura(WebApiProperties properties) throws Exception {
	...
	private static TimerAccettazioneFattura createTimerAccettazioneFattura(WebApiProperties properties) throws Exception {
	...
	private static TimerConsegnaLotto createTimerConsegnaLotto(WebApiProperties properties) throws Exception {
	...
	private static TimerAssociazioneProtocollo createTimerAssociaProtocollo(WebApiProperties properties) throws Exception {
	...
	private static TimerConsegnaEsito createTimerConsegnaEsito(WebApiProperties properties) throws Exception {
