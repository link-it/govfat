 ...
 *
 */
package org.govmix.proxy.fatturapa.web.api.business.riceviNotificaDT;
...
import org.govmix.proxy.fatturapa.web.api.converter.notificadecorrenzatermini.NotificaDecorrenzaTerminiConverter;
...
public class RiceviNotifica {
	...
	public void ricevi(String streamToString) throws Exception {
		NotificaDecorrenzaTerminiConverter converter = new NotificaDecorrenzaTerminiConverter(streamToString);
