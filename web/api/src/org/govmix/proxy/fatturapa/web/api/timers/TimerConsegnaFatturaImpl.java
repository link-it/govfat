...
public class TimerConsegnaFatturaImpl extends AbstractTimerImpl {
	...
	public String getIdModulo() {
		return TimerConsegnaFattura.ID_MODULO;
	}

	@Override
	public AbstractTimerLib getTimerLib() throws Exception {
		return new TimerConsegnaFatturaLib(this.limit,LoggerManager.getBatchConsegnaFatturaLogger(),this.logQuery);
	}
//	/**
//	 * serialVersionUID
//	 */
...
//
//	private TimerConsegnaFatturaLib timerConsegnaFatturaLib;
//
//
//
//
...
//				synchronized (LOCK) {
//					if(LOCK){
//						this.logTimer.info("Timer "+TimerConsegnaFattura.ID_MODULO+" gia' avviato.");
//						stop(timer);
//						return;
//					}
//					else{
...
//				
//				if(this.timerConsegnaFatturaLib == null) {
//					this.timerConsegnaFatturaLib = new TimerConsegnaFatturaLib(this.limit,this.logTimer, this.logQuery);
//				}
//
//				this.timerConsegnaFatturaLib.execute();
//
//			}catch(Exception e){
//				this.logTimer.error("Errore durante la "+TimerConsegnaFattura.ID_MODULO+": "+e.getMessage(),e);
//			}finally{
...
//		if( this.timer != null ){
//
//			this.logTimer.info("Timer "+TimerConsegnaFattura.ID_MODULO+" avviato");
//			return false;
//
//		} else {
//
...
//			}
//
//			if(properties.isTimerConsegnaFatturaAbilitato()){
//				this.logTimer.info("Avvio timer "+TimerConsegnaFattura.ID_MODULO+"");
//				
...
//					this.timer = ts.createTimer(now, timeout, TimerConsegnaFattura.ID_MODULO);
//
//					this.logTimer.info("Timer "+TimerConsegnaFattura.ID_MODULO+" avviato");
//				} catch (Exception e) {
//					stop();
...
//			}else{
//
//				this.logTimer.info("Timer "+TimerConsegnaFattura.ID_MODULO+" disabilitato");
//				return false;
//
//			}
//		}
