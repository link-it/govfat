...
public class TimerInserimentoFatturaImpl extends AbstractTimerImpl {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5581179511305066556L;
...
//		
//		this.timerAbilitato = properties.isTimerInserimentoFatturaAbilitato();
//
//	}
//
//	/**
...
//				synchronized (LOCK) {
//					if(LOCK){
//						this.logTimer.info("Timer "+TimerInserimentoFattura.ID_MODULO+" gia' avviato.");
//						stop(timer);
//						return;
//					}
//					else{
...
//
//			}catch(Exception e){
//				this.logTimer.error("Errore durante la "+TimerInserimentoFattura.ID_MODULO+": "+e.getMessage(),e);
//			}finally{
...
//		if( this.timer != null ){
//
//			this.logTimer.info("Timer "+TimerInserimentoFattura.ID_MODULO+" avviato");
//			return false;
//
//		} else {
//
//			if(this.timerAbilitato){
//				this.logTimer.info("Avvio timer "+TimerInserimentoFattura.ID_MODULO+"");
//				
...
//					this.timer = ts.createTimer(now, timeout, TimerInserimentoFattura.ID_MODULO);
//
//					this.logTimer.info("Timer "+TimerInserimentoFattura.ID_MODULO+" avviato");
//				} catch (Exception e) {
//					stop();
...
//			}else{
//
//				this.logTimer.info("Timer "+TimerInserimentoFattura.ID_MODULO+" disabilitato");
//				return false;
//
//			}
//		}
