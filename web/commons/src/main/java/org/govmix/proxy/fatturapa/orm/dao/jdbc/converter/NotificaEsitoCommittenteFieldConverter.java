...
public class NotificaEsitoCommittenteFieldConverter extends AbstractSQLFieldConverter {
	...
	public String toColumn(IField field,boolean returnAlias,boolean appendTablePrefix) throws ExpressionException {
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NOME)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".nome";
			}else{
				return "nome";
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NODO_CODICE_PAGAMENTO)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".nodo_codice_pagamento";
			}else{
				return "nodo_codice_pagamento";
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.PREFISSO_CODICE_PAGAMENTO)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".prefisso_codice_pagamento";
			}else{
				return "prefisso_codice_pagamento";
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NOME)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".nome";
			}else{
				return "nome";
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NODO_CODICE_PAGAMENTO)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".nodo_codice_pagamento";
			}else{
				return "nodo_codice_pagamento";
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.PREFISSO_CODICE_PAGAMENTO)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".prefisso_codice_pagamento";
			}else{
				return "prefisso_codice_pagamento";
	...
	public String toTable(IField field,boolean returnAlias) throws ExpressionException {
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NOME)){
			return this.toTable(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE, returnAlias);
		}
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NODO_CODICE_PAGAMENTO)){
			return this.toTable(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE, returnAlias);
		}
		...
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NOME)){
			return this.toTable(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE, returnAlias);
		}
		if(field.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE.NODO_CODICE_PAGAMENTO)){
			return this.toTable(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE, returnAlias);
		}
	...
	public String toTable(IModel<?> model,boolean returnAlias) throws ExpressionException {
		...
		if(model.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE)){
			return "enti";
		}
		...
		if(model.equals(NotificaEsitoCommittente.model().FATTURA_ELETTRONICA.LOTTO_FATTURE.DIPARTIMENTO.DIPARTIMENTO_PROPERTY_VALUE.ID_PROPERTY.ID_ENTE)){
			return "enti";
		}
