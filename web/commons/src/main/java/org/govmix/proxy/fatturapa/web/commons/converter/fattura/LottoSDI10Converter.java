...
public class LottoSDI10Converter extends AbstractLottoSDIConverter<FatturaElettronicaType>{
	...
	public LottoSDI10Converter(byte[] fatturaString, ConsegnaFatturaParameters params) throws InserimentoLottiException {
		super(LottoSDI10Converter.readFatturaElettronicaType(fatturaString), fatturaString, params);
	}
	...
	public List<String> getCausali(int index) {
		...
		if(fatturaBody.getDatiGenerali() != null && 
				...
				fatturaBody.getDatiGenerali().getDatiGeneraliDocumento().getCausale() != null) {
			lst.add(fatturaBody.getDatiGenerali().getDatiGeneraliDocumento().getCausale());
		}
