...
/**     
 * DipartimentoPropertyFieldConverter
 *
 ...
 * @version $Rev$, $Date$
 */
public class DipartimentoPropertyFieldConverter extends AbstractSQLFieldConverter {

	private TipiDatabase databaseType;
	
	public DipartimentoPropertyFieldConverter(String databaseType){
		this.databaseType = TipiDatabase.toEnumConstant(databaseType);
	}
	public DipartimentoPropertyFieldConverter(TipiDatabase databaseType){
	...
	public IModel<?> getRootModel() throws ExpressionException {
		return DipartimentoProperty.model();
	}
	...
	public String toColumn(IField field,boolean returnAlias,boolean appendTablePrefix) throws ExpressionException {
		...
		if(field.equals(DipartimentoProperty.model().NOME)){
