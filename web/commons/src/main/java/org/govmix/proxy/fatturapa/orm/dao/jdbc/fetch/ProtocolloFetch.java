 ...
 * @version $Rev$, $Date$
 */
public class ProtocolloFetch extends AbstractJDBCFetch {
	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , ResultSet rs) throws ServiceException {
		...
		try{
			...
			if(model.equals(Protocollo.model())){
				Protocollo object = new Protocollo();
				setParameter(object, "setId", Long.class,
					jdbcParameterUtilities.readParameter(rs, "id", Long.class));
				setParameter(object, "setNome", Protocollo.model().NOME.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "nome", Protocollo.model().NOME.getFieldType()));
				setParameter(object, "setDescrizione", Protocollo.model().DESCRIZIONE.getFieldType(),
	...
	public IKeyGeneratorObject getKeyGeneratorObject( IModel<?> model )  throws ServiceException {
		...
		try{
			...
			if(model.equals(Protocollo.model())){
				return new org.openspcoop2.utils.jdbc.CustomKeyGeneratorObject("protocolli","id","seq_protocolli","protocolli_init_seq");
			}
