	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , ResultSet rs) throws ServiceException {
		...
		try{
			...
			if(model.equals(TracciaSDI.model())){
				...
				setParameter(object, "setCodiceDipartimento", TracciaSDI.model().CODICE_DIPARTIMENTO.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "codice_dipartimento", TracciaSDI.model().CODICE_DIPARTIMENTO.getFieldType()));
