...
import org.govmix.proxy.fatturapa.orm.dao.jdbc.JDBCLimitedServiceManager;
import org.govmix.proxy.fatturapa.orm.NotificaDecorrenzaTermini;
import org.govmix.proxy.fatturapa.orm.dao.IDBNotificaDecorrenzaTerminiServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.NotificaDecorrenzaTermini} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCNotificaDecorrenzaTerminiServiceSearch implements IDBNotificaDecorrenzaTerminiServiceSearch, IDBServiceUtilities<NotificaDecorrenzaTermini> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<NotificaDecorrenzaTermini, IdNotificaDecorrenzaTermini, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCNotificaDecorrenzaTerminiServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCNotificaDecorrenzaTerminiServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("notificaDecorrenzaTermini");
	...
	@Override
	public void validate(NotificaDecorrenzaTermini notificaDecorrenzaTermini) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(notificaDecorrenzaTermini, this.log, 
				org.govmix.proxy.fatturapa.orm.utils.XSDValidator.getXSDValidator(this.log));
	}
	...
	@Override
	public IdNotificaDecorrenzaTermini convertToId(NotificaDecorrenzaTermini obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+NotificaDecorrenzaTermini.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public NotificaDecorrenzaTermini get(IdNotificaDecorrenzaTermini id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaDecorrenzaTermini get(IdNotificaDecorrenzaTermini id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdNotificaDecorrenzaTermini id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdNotificaDecorrenzaTermini> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdNotificaDecorrenzaTermini> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<NotificaDecorrenzaTermini> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<NotificaDecorrenzaTermini> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public NotificaDecorrenzaTermini find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaDecorrenzaTermini find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdNotificaDecorrenzaTermini id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdNotificaDecorrenzaTermini id, NotificaDecorrenzaTermini obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, NotificaDecorrenzaTermini obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdNotificaDecorrenzaTermini.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+NotificaDecorrenzaTermini.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public NotificaDecorrenzaTermini get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaDecorrenzaTermini get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdNotificaDecorrenzaTermini findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdNotificaDecorrenzaTermini id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
