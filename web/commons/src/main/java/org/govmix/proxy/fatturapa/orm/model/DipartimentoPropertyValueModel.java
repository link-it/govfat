...
public class DipartimentoPropertyValueModel extends AbstractModel<DipartimentoPropertyValue> {
	...
	public DipartimentoPropertyValueModel(){
		...
		this.ID_PROPERTY = new org.govmix.proxy.fatturapa.orm.model.IdDipartimentoPropertyModel(new Field("id-property",org.govmix.proxy.fatturapa.orm.IdDipartimentoProperty.class,"DipartimentoPropertyValue",DipartimentoPropertyValue.class));
	...
	public DipartimentoPropertyValueModel(IField father){
		...
		this.ID_PROPERTY = new org.govmix.proxy.fatturapa.orm.model.IdDipartimentoPropertyModel(new ComplexField(father,"id-property",org.govmix.proxy.fatturapa.orm.IdDipartimentoProperty.class,"DipartimentoPropertyValue",DipartimentoPropertyValue.class));
	...
	public org.govmix.proxy.fatturapa.orm.model.IdDipartimentoPropertyModel ID_PROPERTY = null;
