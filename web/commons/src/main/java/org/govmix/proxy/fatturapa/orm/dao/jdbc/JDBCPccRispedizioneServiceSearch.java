...
import org.govmix.proxy.fatturapa.orm.dao.IDBPccRispedizioneServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.PccRispedizione} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCPccRispedizioneServiceSearch implements IDBPccRispedizioneServiceSearch, IDBServiceUtilities<PccRispedizione> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<PccRispedizione, IdRispedizione, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCPccRispedizioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPccRispedizioneServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("pccRispedizione");
	...
	@Override
	public void validate(PccRispedizione pccRispedizione) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(pccRispedizione, this.log, 
	...
	@Override
	public IdRispedizione convertToId(PccRispedizione obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PccRispedizione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccRispedizione get(IdRispedizione id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccRispedizione get(IdRispedizione id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdRispedizione id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdRispedizione> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdRispedizione> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccRispedizione> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccRispedizione> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public PccRispedizione find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public PccRispedizione find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdRispedizione id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdRispedizione id, PccRispedizione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, PccRispedizione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdRispedizione.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+PccRispedizione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccRispedizione get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccRispedizione get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdRispedizione findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdRispedizione id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
