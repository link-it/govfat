...
public class IdTrasmissioneModel extends AbstractModel<IdTrasmissione> {
	...
	public IdTrasmissioneModel(){
		...
		this.ID_TRASMISSIONE = new Field("idTrasmissione",long.class,"id-trasmissione",IdTrasmissione.class);
	...
	public IdTrasmissioneModel(IField father){
		...
		this.ID_TRASMISSIONE = new ComplexField(father,"idTrasmissione",long.class,"id-trasmissione",IdTrasmissione.class);
	
	}
	
	

	public IField ID_TRASMISSIONE = null;
