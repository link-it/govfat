...
public class IdNotificaDecorrenzaTerminiModel extends AbstractModel<IdNotificaDecorrenzaTermini> {
	...
	public IdNotificaDecorrenzaTerminiModel(){
		...
		this.IDENTIFICATIVO_SDI = new Field("identificativoSdi",java.lang.Integer.class,"id-notifica-decorrenza-termini",IdNotificaDecorrenzaTermini.class);
	...
	public IdNotificaDecorrenzaTerminiModel(IField father){
		...
		this.IDENTIFICATIVO_SDI = new ComplexField(father,"identificativoSdi",java.lang.Integer.class,"id-notifica-decorrenza-termini",IdNotificaDecorrenzaTermini.class);
