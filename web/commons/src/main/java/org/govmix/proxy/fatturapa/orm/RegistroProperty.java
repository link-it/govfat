...
public class RegistroProperty extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static org.govmix.proxy.fatturapa.orm.model.RegistroPropertyModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(org.govmix.proxy.fatturapa.orm.RegistroProperty.modelStaticInstance==null){
  			org.govmix.proxy.fatturapa.orm.RegistroProperty.modelStaticInstance = new org.govmix.proxy.fatturapa.orm.model.RegistroPropertyModel();
	  }
  }
  public static org.govmix.proxy.fatturapa.orm.model.RegistroPropertyModel model(){
	  if(org.govmix.proxy.fatturapa.orm.RegistroProperty.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return org.govmix.proxy.fatturapa.orm.RegistroProperty.modelStaticInstance;
  }
