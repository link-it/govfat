...
import org.govmix.proxy.fatturapa.orm.dao.IDBPccPagamentoServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.PccPagamento} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCPccPagamentoServiceSearch implements IDBPccPagamentoServiceSearch, IDBServiceUtilities<PccPagamento> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<PccPagamento, IdPagamento, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCPccPagamentoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPccPagamentoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("pccPagamento");
	...
	@Override
	public void validate(PccPagamento pccPagamento) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(pccPagamento, this.log, 
	...
	@Override
	public IdPagamento convertToId(PccPagamento obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PccPagamento.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccPagamento get(IdPagamento id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccPagamento get(IdPagamento id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public List<PccPagamento> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccPagamento> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public PccPagamento find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public PccPagamento find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdPagamento id, PccPagamento obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, PccPagamento obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public PccPagamento get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccPagamento get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
