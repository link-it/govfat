...
import org.govmix.proxy.fatturapa.orm.dao.IDBEventoService;
...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.orm.Evento} 
 *
...
public class JDBCEventoService extends JDBCEventoServiceSearch  implements IDBEventoService {
	...
	public JDBCEventoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.serviceCRUD = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceCRUD("evento");
