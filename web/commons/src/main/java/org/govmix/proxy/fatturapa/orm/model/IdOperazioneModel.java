...
public class IdOperazioneModel extends AbstractModel<IdOperazione> {
	...
	public IdOperazioneModel(){
		...
		this.NOME = new Field("nome",java.lang.String.class,"id-operazione",IdOperazione.class);
	...
	public IdOperazioneModel(IField father){
		...
		this.NOME = new ComplexField(father,"nome",java.lang.String.class,"id-operazione",IdOperazione.class);
