...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.Registro} 
 *
...
public class JDBCRegistroServiceSearch implements IDBRegistroServiceSearch, IDBServiceUtilities<Registro> {
	...
	protected IJDBCRegistroServiceSearch serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCRegistroServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCRegistroServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("registro");
	...
	@Override
	public void validate(Registro registro) throws ServiceException,
	...
	@Override
	public IdRegistro convertToId(Registro obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Registro.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public Registro get(IdRegistro id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public Registro get(IdRegistro id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdRegistro id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdRegistro> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdRegistro> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<Registro> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<Registro> findAll(IPaginatedExpression expression, boolean fetchChildren) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<Registro> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<Registro> findAll(IPaginatedExpression expression, boolean fetchChildren, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		...
		try{
			...
			return this.serviceSearch.findAll(this.jdbcProperties,this.log,connection,sqlQueryObject,jdbcPaginatedExpression, fetchChildren, idMappingResolutionBehaviour);			
	...
	@Override
	public Registro find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public Registro find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdRegistro id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdRegistro id, Registro obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, Registro obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdRegistro.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Registro.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public Registro get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public Registro get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdRegistro findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdRegistro id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
