...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.DipartimentoProperty} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCDipartimentoPropertyServiceSearch implements IDBDipartimentoPropertyServiceSearch, IDBServiceUtilities<DipartimentoProperty> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<DipartimentoProperty, IdDipartimentoProperty, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCDipartimentoPropertyServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCDipartimentoPropertyServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("dipartimentoProperty");
	...
	@Override
	public void validate(DipartimentoProperty dipartimentoProperty) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(dipartimentoProperty, this.log, 
	...
	@Override
	public IdDipartimentoProperty convertToId(DipartimentoProperty obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+DipartimentoProperty.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public DipartimentoProperty get(IdDipartimentoProperty id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public DipartimentoProperty get(IdDipartimentoProperty id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdDipartimentoProperty id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdDipartimentoProperty> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdDipartimentoProperty> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<DipartimentoProperty> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<DipartimentoProperty> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public DipartimentoProperty find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public DipartimentoProperty find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdDipartimentoProperty id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdDipartimentoProperty id, DipartimentoProperty obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, DipartimentoProperty obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdDipartimentoProperty.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+DipartimentoProperty.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public DipartimentoProperty get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public DipartimentoProperty get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdDipartimentoProperty findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdDipartimentoProperty id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
