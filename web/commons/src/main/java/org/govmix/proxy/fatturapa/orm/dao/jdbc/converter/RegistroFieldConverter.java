...
public class RegistroFieldConverter extends AbstractSQLFieldConverter {
	...
	public String toColumn(IField field,boolean returnAlias,boolean appendTablePrefix) throws ExpressionException {
		...
		if(field.equals(Registro.model().ID_PROTOCOLLO.NOME)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".nome";
			}else{
				return "nome";
		...
		if(field.equals(Registro.model().REGISTRO_PROPERTY_VALUE.ID_PROPERTY.ID_PROTOCOLLO.NOME)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".nome";
			}else{
				return "nome";
	...
	public String toTable(IField field,boolean returnAlias) throws ExpressionException {
		...
		if(field.equals(Registro.model().ID_PROTOCOLLO.NOME)){
			return this.toTable(Registro.model().ID_PROTOCOLLO, returnAlias);
		}
		if(field.equals(Registro.model().REGISTRO_PROPERTY_VALUE.VALORE)){
		...
		if(field.equals(Registro.model().REGISTRO_PROPERTY_VALUE.ID_PROPERTY.ID_PROTOCOLLO.NOME)){
			return this.toTable(Registro.model().REGISTRO_PROPERTY_VALUE.ID_PROPERTY.ID_PROTOCOLLO, returnAlias);
		}
	...
	public String toTable(IModel<?> model,boolean returnAlias) throws ExpressionException {
		...
		if(model.equals(Registro.model().REGISTRO_PROPERTY_VALUE.ID_PROPERTY.ID_PROTOCOLLO)){
