...
public class ProtocollazioneUtils {
	...
	public boolean forzaInvioLotto(Long idSdI, boolean consegnaDocumentiAssociati) throws Exception {
	...
	public boolean forzaInvioFattura(Long idSdI, Integer posizione, boolean consegnaDocumentiAssociati) throws Exception {
		Connection conn = null;
		try {
			conn = DAOFactory.getInstance().getConnection();
			conn.setAutoCommit(false);
	...
	public boolean forzaInvioFattura(Long idSdI, Integer posizione, boolean consegnaDocumentiAssociati, Connection conn) throws Exception {
		boolean esitoPositivo = false;
