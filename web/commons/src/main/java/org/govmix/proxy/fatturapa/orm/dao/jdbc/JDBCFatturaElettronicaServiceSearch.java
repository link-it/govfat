...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.FatturaElettronica} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCFatturaElettronicaServiceSearch implements IDBFatturaElettronicaServiceSearch, IDBServiceUtilities<FatturaElettronica> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<FatturaElettronica, IdFattura, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCFatturaElettronicaServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCFatturaElettronicaServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("fatturaElettronica");
	...
	@Override
	public void validate(FatturaElettronica fatturaElettronica) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(fatturaElettronica, this.log, 
	...
	@Override
	public IdFattura convertToId(FatturaElettronica obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+FatturaElettronica.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public FatturaElettronica get(IdFattura id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public FatturaElettronica get(IdFattura id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdFattura id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdFattura> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdFattura> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<FatturaElettronica> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<FatturaElettronica> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public FatturaElettronica find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public FatturaElettronica find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdFattura id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdFattura id, FatturaElettronica obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, FatturaElettronica obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdFattura.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+FatturaElettronica.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public FatturaElettronica get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public FatturaElettronica get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdFattura findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdFattura id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
	...
	public int nativeUpdate(String sql,Object ... param) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			return ((JDBCFatturaElettronicaServiceSearchImpl)this.serviceSearch).nativeUpdate(this.jdbcProperties,this.log,connection,sqlQueryObject,sql,param);		
