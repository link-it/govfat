...
import org.govmix.proxy.fatturapa.orm.dao.IDBNotificaEsitoCommittenteServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.NotificaEsitoCommittente} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCNotificaEsitoCommittenteServiceSearch implements IDBNotificaEsitoCommittenteServiceSearch, IDBServiceUtilities<NotificaEsitoCommittente> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<NotificaEsitoCommittente, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCNotificaEsitoCommittenteServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCNotificaEsitoCommittenteServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("notificaEsitoCommittente");
	...
	@Override
	public void validate(NotificaEsitoCommittente notificaEsitoCommittente) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(notificaEsitoCommittente, this.log, 
	...
	@Override
	public List<NotificaEsitoCommittente> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<NotificaEsitoCommittente> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public NotificaEsitoCommittente find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaEsitoCommittente find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaEsitoCommittente get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaEsitoCommittente get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
