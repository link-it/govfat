...
/**     
 * Enumeration dell'elemento NotificaEsitoCommittente.statoConsegnaSdi xsd (tipo:string) 
 *
...
public enum StatoConsegnaType implements IEnumeration , Serializable , Cloneable {
	...
	public static StatoConsegnaType toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
