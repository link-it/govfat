...
public class IdUtenteModel extends AbstractModel<IdUtente> {
	...
	public IdUtenteModel(){
		...
		this.USERNAME = new Field("username",java.lang.String.class,"id-utente",IdUtente.class);
	...
	public IdUtenteModel(IField father){
		...
		this.USERNAME = new ComplexField(father,"username",java.lang.String.class,"id-utente",IdUtente.class);
