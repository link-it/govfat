...
public class InserimentoLottiException extends Exception {
	...
	public enum CODICE {ERRORE_GENERICO, ERRORE_DIPARTIMENTO_NON_ABILITATO, PARAMETRI_NON_VALIDI, ERRORE_FILE_FIRMATO, ERRORE_FILE_NON_FIRMATO, ERRORE_FORMATO_FILE, ERRORE_FILE_NON_FIRMATO_CONSERVAZIONE}
