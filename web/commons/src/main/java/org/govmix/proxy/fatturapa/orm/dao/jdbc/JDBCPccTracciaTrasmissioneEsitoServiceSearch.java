...
import org.govmix.proxy.fatturapa.orm.dao.IDBPccTracciaTrasmissioneEsitoServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.PccTracciaTrasmissioneEsito} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCPccTracciaTrasmissioneEsitoServiceSearch implements IDBPccTracciaTrasmissioneEsitoServiceSearch, IDBServiceUtilities<PccTracciaTrasmissioneEsito> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<PccTracciaTrasmissioneEsito, IdTrasmissioneEsito, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCPccTracciaTrasmissioneEsitoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPccTracciaTrasmissioneEsitoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("pccTracciaTrasmissioneEsito");
	...
	@Override
	public void validate(PccTracciaTrasmissioneEsito pccTracciaTrasmissioneEsito) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(pccTracciaTrasmissioneEsito, this.log, 
	...
	@Override
	public IdTrasmissioneEsito convertToId(PccTracciaTrasmissioneEsito obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PccTracciaTrasmissioneEsito.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccTracciaTrasmissioneEsito get(IdTrasmissioneEsito id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissioneEsito get(IdTrasmissioneEsito id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdTrasmissioneEsito id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdTrasmissioneEsito> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdTrasmissioneEsito> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccTracciaTrasmissioneEsito> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccTracciaTrasmissioneEsito> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissioneEsito find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissioneEsito find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdTrasmissioneEsito id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdTrasmissioneEsito id, PccTracciaTrasmissioneEsito obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, PccTracciaTrasmissioneEsito obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdTrasmissioneEsito.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+PccTracciaTrasmissioneEsito.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccTracciaTrasmissioneEsito get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissioneEsito get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdTrasmissioneEsito findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdTrasmissioneEsito id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
