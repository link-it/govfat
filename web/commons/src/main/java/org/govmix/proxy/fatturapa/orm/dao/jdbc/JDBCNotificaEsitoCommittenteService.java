...
/**     
 * Service can be used to search for and manage the backend objects of type {@link org.govmix.proxy.fatturapa.orm.NotificaEsitoCommittente} 
 *
...
public class JDBCNotificaEsitoCommittenteService extends JDBCNotificaEsitoCommittenteServiceSearch  implements IDBNotificaEsitoCommittenteService {
	...
	public void create(NotificaEsitoCommittente notificaEsitoCommittente) throws ServiceException, NotImplementedException {
		try{
			this.create(notificaEsitoCommittente, false, null);
	...
	@Override
	public void create(NotificaEsitoCommittente notificaEsitoCommittente, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.create(notificaEsitoCommittente, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void create(NotificaEsitoCommittente notificaEsitoCommittente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.create(notificaEsitoCommittente, validate, null);
	}
	
	@Override
	public void create(NotificaEsitoCommittente notificaEsitoCommittente, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,notificaEsitoCommittente,idMappingResolutionBehaviour);			
	...
	public void update(NotificaEsitoCommittente notificaEsitoCommittente) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(notificaEsitoCommittente, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(NotificaEsitoCommittente notificaEsitoCommittente, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(notificaEsitoCommittente, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void update(NotificaEsitoCommittente notificaEsitoCommittente, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(notificaEsitoCommittente, validate, null);
	}
		
	@Override
	public void update(NotificaEsitoCommittente notificaEsitoCommittente, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,notificaEsitoCommittente,idMappingResolutionBehaviour);
	...
	@Override
	public void update(long tableId, NotificaEsitoCommittente notificaEsitoCommittente) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, notificaEsitoCommittente, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, NotificaEsitoCommittente notificaEsitoCommittente, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, notificaEsitoCommittente, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, NotificaEsitoCommittente notificaEsitoCommittente, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(tableId, notificaEsitoCommittente, validate, null);
	}
		
	@Override
	public void update(long tableId, NotificaEsitoCommittente notificaEsitoCommittente, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,notificaEsitoCommittente,idMappingResolutionBehaviour);
	...
	public void updateOrCreate(NotificaEsitoCommittente notificaEsitoCommittente) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(notificaEsitoCommittente, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(NotificaEsitoCommittente notificaEsitoCommittente, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(notificaEsitoCommittente, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	public void updateOrCreate(NotificaEsitoCommittente notificaEsitoCommittente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(notificaEsitoCommittente, validate, null);
	}

	@Override
	public void updateOrCreate(NotificaEsitoCommittente notificaEsitoCommittente, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,notificaEsitoCommittente,idMappingResolutionBehaviour);
	...
	@Override
	public void updateOrCreate(long tableId, NotificaEsitoCommittente notificaEsitoCommittente) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, notificaEsitoCommittente, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, NotificaEsitoCommittente notificaEsitoCommittente, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, notificaEsitoCommittente, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, NotificaEsitoCommittente notificaEsitoCommittente, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(tableId, notificaEsitoCommittente, validate, null);
	}

	@Override
	public void updateOrCreate(long tableId, NotificaEsitoCommittente notificaEsitoCommittente, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,notificaEsitoCommittente,idMappingResolutionBehaviour);
