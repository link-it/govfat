...
import org.govmix.proxy.fatturapa.orm.dao.IDBPccTracciaTrasmissioneServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link org.govmix.proxy.fatturapa.orm.PccTracciaTrasmissione} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCPccTracciaTrasmissioneServiceSearch implements IDBPccTracciaTrasmissioneServiceSearch, IDBServiceUtilities<PccTracciaTrasmissione> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<PccTracciaTrasmissione, IdTrasmissione, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCPccTracciaTrasmissioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPccTracciaTrasmissioneServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("pccTracciaTrasmissione");
	...
	@Override
	public void validate(PccTracciaTrasmissione pccTracciaTrasmissione) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(pccTracciaTrasmissione, this.log, 
	...
	@Override
	public IdTrasmissione convertToId(PccTracciaTrasmissione obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PccTracciaTrasmissione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccTracciaTrasmissione get(IdTrasmissione id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissione get(IdTrasmissione id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdTrasmissione id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdTrasmissione> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdTrasmissione> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccTracciaTrasmissione> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<PccTracciaTrasmissione> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissione find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissione find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdTrasmissione id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdTrasmissione id, PccTracciaTrasmissione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, PccTracciaTrasmissione obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdTrasmissione.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+PccTracciaTrasmissione.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public PccTracciaTrasmissione get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public PccTracciaTrasmissione get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdTrasmissione findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdTrasmissione id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
