...
public class NotificaECMBean extends BaseFormMBean<NotificaECBean, Long, NotificaECForm> {
	...
	public void setForm(NotificaECForm form) {
		...
		this.form.getEsito().setElencoSelectItems(this.getListaEsiti());
	...
	public String invia(){
		log.debug("Inserimento della notifica in corso...");
		...
		try{
			...
			InvioNotificaEsitoCommittente sender = new InvioNotificaEsitoCommittente(log);
	...
	public String validaInput(){
		...
		FormField<String> descrizione = this.form.getDescrizione();
