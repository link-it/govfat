...
<!--[if !(IE)]><!-->
		<link
			href="../../css/roboto/roboto-fontface.css"
		...
		<!--[if lte IE 8]>
     	<link
			href="../../css/roboto/roboto-fontface-iefix.css"
			rel="stylesheet" type="text/css" />
    	<![endif]-->
<!-- Generic page styles -->
...
<!-- Icone applicazione -->
<link rel="stylesheet" href="../../css/linkit-icons.css">
<%
    ...
    <tr class="template-download fade">
        <td >
            <p class="name">
                <span>{%=file.name%}</span>
				{% if (!file.error) { %}
					<span class="iconCaricamentoOk icon-check-green"></span>
				{% } %}
            </p>
