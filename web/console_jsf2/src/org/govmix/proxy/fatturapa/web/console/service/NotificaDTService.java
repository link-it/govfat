...
public class NotificaDTService implements INotificaDTService{
	...
	public List<NotificaDTBean> findAll(int start, int limit)
		...
		try {
			...
			log.error("Si e' verificato un errore durante la find all notifiche decorrenza termini:" + e.getMessage(), e);
			throw e;
	...
	public int totalCount() throws ServiceException {
		...
		try {
			...
			log.error("Si e' verificato un errore durante la count notifiche decorrenza termini:" + e.getMessage(), e);
			throw e;
		}  catch (NotImplementedException e) {
			log.error("Si e' verificato un errore durante la count notifiche decorrenza termini:" + e.getMessage(), e);
			throw new ServiceException(e);
