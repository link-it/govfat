...
public class AllegatiService implements IAllegatiService{
	...
	public List<AllegatoFatturaBean> findAll(int start, int limit)
		...
		try {
			...
			IExpression expr = NotificaECService.getFiltroRicerca(this.idFattura,this.allegatoSearchDAO, this.idFatturaModel,log);
			...
			log.error("Si e' verificato un errore durante la find all allegati:" + e.getMessage(), e);
			throw e;
	...
	public int totalCount() throws ServiceException {
		...
		try {
			...
			log.error("Si e' verificato un errore durante la count allegati:" + e.getMessage(), e);
			throw e;
		}  catch (NotImplementedException e) {
			log.error("Si e' verificato un errore durante la count allegati:" + e.getMessage(), e);
			throw new ServiceException(e);
