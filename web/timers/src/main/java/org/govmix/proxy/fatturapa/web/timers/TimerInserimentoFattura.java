...
/**
 * Interfaccia del thread che si occupa di consegnare le fatture all'ente destinatario
 * 
 * 
...
public interface TimerInserimentoFattura extends IEJBTimer {

    /* ********  F I E L D S  P R I V A T I   S T A T I C I  ******** */
    
    /** Variabile che indica il Nome del modulo rappresentato da questa classe */
    public final static String ID_MODULO = "inserimentoFattura";
