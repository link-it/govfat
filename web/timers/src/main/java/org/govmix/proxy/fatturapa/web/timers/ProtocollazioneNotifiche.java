...
//		boolean esitoPositivo = false;
		...
		try{
			...
			if(tracciaSDI.getDettaglioProtocollazione()!=null) {
				httpConn.setRequestProperty(CostantiProtocollazione.DETTAGLIO_CONSEGNA_HEADER_PARAM, tracciaSDI.getDettaglioProtocollazione());
			}
