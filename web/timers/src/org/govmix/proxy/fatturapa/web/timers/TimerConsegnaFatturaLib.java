						...
						for(FatturaElettronica fattura : lstId) {
							...
							try {
								...
								try{
									...
									this.log.debug("Esito: "+ httpConn.getResponseCode());
								...
								if(esitoPositivo) {
									...
									this.log.debug("Fattura ["+idFattura.toJson()+"] inviata con errore all'endpoint ["+url+"], codice di risposta ["+httpConn.getResponseCode()+"]. Dettaglio: ["+response+"]");
									fatturaElettronicaBD.updateStatoConsegna(idFattura, response);
