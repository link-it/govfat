...
public class TimerInserimentoFatturaLib extends AbstractTimerLib {
	...
	public void execute() throws Exception {
		...
		try {
			...
			ConsegnaFattura consegnaFattura = new ConsegnaFattura(log, BatchProperties.getInstance().isValidazioneDAOAbilitata(), connection, false);
					...
					try {
						for(LottoFatture lotto : lstLotti) {
							...
							try{ 
								...
								if(BatchProperties.getInstance().isRifiutoAutomaticoAbilitato()) {
