...
(
	...
	richiesta_xml VARBINARY(MAX) NOT NULL,
	risposta_xml VARBINARY(MAX),
	operazione VARCHAR(255) NOT NULL,
	tipo_operazione VARCHAR(255) NOT NULL,
	stato VARCHAR(255) NOT NULL,
	data_ultima_trasmissione DATETIME2 NOT NULL,
	data_ultimo_tentativo_esito DATETIME2,
	codici_errore VARCHAR(1000),
	rispedizione BIT NOT NULL DEFAULT 'false',
	rispedizione_dopo_query BIT NOT NULL,
	rispedizione_max_tentativi INT,
	rispedizione_prox_tentativo DATETIME2,
	rispedizione_numero_tentativi INT,
	rispedizione_ultimo_tentativo DATETIME2,
	-- fk/pk columns
	id BIGINT IDENTITY,
	-- check constraints
...
(
	ts_trasmissione DATETIME2 NOT NULL,
	...
	data_fine_elaborazione DATETIME2,
	dettaglio_errore_trasmissione VARCHAR(max),
...
(
	...
	descrizione_elaborazione VARCHAR(max),
	data_fine_elaborazione DATETIME2,
	gdo DATETIME2 NOT NULL,
	esito_trasmissione VARCHAR(255) NOT NULL,
	dettaglio_errore_trasmissione VARCHAR(max),
...
(
	...
	data_consegna DATETIME2,
	data_prossima_consegna DATETIME2,
...
(
	...
	nome_file VARCHAR(50) NOT NULL,
	modalita_batch BIT NOT NULL DEFAULT 'false',
	data_invio_ente DATETIME2 NOT NULL,
	data_invio_sdi DATETIME2,
	stato_consegna_sdi VARCHAR(255) NOT NULL DEFAULT 'NON_CONSEGNATA',
	data_ultima_consegna_sdi DATETIME2,
	data_prossima_consegna_sdi DATETIME2,
...
(
	...
	accettazione_automatica BIT NOT NULL DEFAULT 'false',
	modalita_push BIT NOT NULL DEFAULT 'true',
	lista_email_notifiche VARCHAR(max),
	-- fk/pk columns
	id BIGINT IDENTITY,
...
(
	importo_movimento REAL NOT NULL,
...
(
	importo_in_scadenza REAL,
	importo_iniziale REAL,
	pagato_ricontabilizzato REAL,
	data_scadenza DATE,
	sistema_richiedente VARCHAR(255) NOT NULL,
	utente_richiedente VARCHAR(255) NOT NULL,
	data_richiesta DATETIME2 NOT NULL,
...
(
	...
	descrizione_errore VARCHAR(max) NOT NULL,
